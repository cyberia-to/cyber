...
title: color
tags: cyber, core
alias: colors, color-emotion, evolutionary theory of color, цвета
crystal-type: relation
crystal-domain: culture
---
# color — the evolutionary map to emotion
...
the full framework — ecological valence, trichromatic foraging, the amygdala's integration, the cross-cultural evidence — is the article: [[color-emotion spectrum]], published at [x.com/mastercyb](https://x.com/mastercyb/status/1983247076147568862).
...
- **[[emotion]] in the protocol** — [[prysm]] computes affect as color: a failing counter glows red, a fresh [[cyberlink]] glows green, an unexplored [[file]] glows blue. emotion makes the [[cybergraph]] legible to human perception.
