# cyber candidate-20260924.1 — RED
...
error: failed to select a version for `cybergraph`.
    ... required by package `true-cyber v0.8.0 (/home/runner/work/_temp/sources/cyber)`
versions that meet the requirements `*` (locked to 0.1.1) are: 0.1.1

package `true-cyber` depends on `cybergraph` with feature `local-storage` but `cybergraph` does not have that feature.
...
- aarch64-apple-darwin: cyber-tests — red
- aarch64-apple-darwin: cyber-release — red
- aarch64-apple-darwin: optica-build — red
- aarch64-apple-darwin: protocol-graph — optica builder failed
- aarch64-apple-darwin: package-resolution — cargo exited 101: Updating crates.io index
    Updating crates.io index
error: failed to select a version for `cybergraph`.
    ... required by package `true-cyber v0.8.0 (/Users/runner/work/_temp/sources/cyber)`
versions that meet the requirements `*` (locked to 0.1.1) are: 0.1.1
...
- x86_64-apple-darwin: cyber-tests — red
- x86_64-apple-darwin: cyber-release — red
- x86_64-apple-darwin: optica-build — red
- x86_64-apple-darwin: protocol-graph — optica builder failed
...
- aarch64-unknown-linux-gnu: cyber-tests — red
- aarch64-unknown-linux-gnu: cyber-release — red
- aarch64-unknown-linux-gnu: optica-build — red
- aarch64-unknown-linux-gnu: protocol-graph — optica builder failed
...
- x86_64-unknown-linux-gnu: cyber-tests — red
- x86_64-unknown-linux-gnu: cyber-release — red
- x86_64-unknown-linux-gnu: optica-build — red
- x86_64-unknown-linux-gnu: protocol-graph — optica builder failed
