...
Moving value without a bank is a solved problem: open networks already settle transfers without a trusted ledger-keeper. moving *intelligence* without a platform is not. a few closed models train on humanity for free and sell the result back. open publication does not record who taught what, does not compute what is worth attending to, and does not pay for truth — the ranking still belongs to whoever runs the index. knowledge has the free-rider problem value had before open money: everyone reads, nobody is paid to teach, the shared picture degrades.
