...
the simulation is provable: if required, the counterfactual computation runs as a Trident program with [[zheng]] proof output. the system can prove it chose the projected-optimal parameter adjustment.
