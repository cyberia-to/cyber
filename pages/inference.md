...
these outputs are deterministic, verified in [[consensus]], and visible to all [[neurons]]. [[neurons]] observe them, derive [[implicit knowledge]], and feed it back as new [[cyberlinks]]. inference feeds the loop
