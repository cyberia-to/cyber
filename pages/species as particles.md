...
- ## from graph to protocol
  this Logseq graph is a prototype. the [[species]] pages, the `[[wiki-links]]`, the tags — they ARE a knowledge graph. the step from markdown to [[Bostrom]] is not conceptual. it is mechanical:
