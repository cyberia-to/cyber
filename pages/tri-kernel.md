...
- the only operator families that survive the locality constraint required for planetary-scale computation
- the [[tru]] runs the tri-kernel on the [[cybergraph]] in [[consensus]]
