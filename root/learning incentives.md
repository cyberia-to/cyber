...
rewards are proportional to $\Delta\phi^*$ — the [[focus]] gained by the target [[particle]] after a [[cyberlink]] is added to the [[cybergraph]]. a neuron that links a previously overlooked particle to a relevant context receives the largest reward
