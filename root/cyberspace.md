...
diffusion: 0.00012857005321999275
springs: 0.0017823671247282245
heat: 0.0012693911882818779
focus: 0.0008528734016848284
gravity: 3
density: 2.67
---
# cyberspace
...
the key insight: when [[markup]] rules are applied to a tree-graph, the result is not a richer document format. it is a new kind of space — one that can be inhabited, navigated, and [[observation|observed]] from within
...
- at `~/cyber/truth` — you see your personal version of that concept, with your own [[cyberlinks]], your own annotations, your own [[cyberank]]
...
- every `#reference` inside is a [[cyberlink]] being created
- every `##header` is a sub-coordinate (`cyber/truth/subheading`)
- the text between references is the human-readable surface
...
this means:
- editing a document changes its [[Hemera|CID]] — it becomes a new [[particle]]
...
[[markup|cybermark]] is not a formatting tool. it is the grammar of cyberspace — the rules by which [[particles]], [[cyberlinks]], paths, names, [[tokens]], and actions are expressed in human-writable form
...
|---------|----------------------|
| world wide web | links are typed, weighted, and attributed. no dead links — [[Hemera|CIDs]] are permanent |
