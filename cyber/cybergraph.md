...
a cybergraph is a triple $\mathbb{G} = (P, N, L)$: content-addressed [[particles]] (the identities of the [[files]] a cyberlink connects), authenticated [[neurons]], and a multiset of staked [[cyberlinks]] — with [[tokens]] and [[karma]] derived from $L$, never primitive. everything else the protocol does is a reading of this triple
