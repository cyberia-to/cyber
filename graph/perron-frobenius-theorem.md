...
|----------|-----------------|
| [[focus]] $\pi^*$ exists | unique stationary distribution |
| all $\pi^*_p > 0$ | every particle has positive attention |
| $\pi^*$ is independent of initial distribution | any $\phi^{(0)} \to \pi^*$ |
| convergence rate is geometric | $\|\phi^{(t)} - \pi^*\|_1 \leq C(1-\lambda_2)^t$ |
