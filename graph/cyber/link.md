...
cyberlinks are bundled into [[signals]] for broadcast. the [[signal]] adds the computational layer: a $\pi_\Delta$ (sparse [[focus]] update) and a [[STARK]] proof covering the entire batch of links. see [[signal]] for the full specification
