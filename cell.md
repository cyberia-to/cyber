...
how a cell divides — the [[Laplacian]] eigengap trigger, the Fiedler cut, state migration — is a separate proposal, deliberately unimplemented: [[spectral cell division]]. under the [[research/oikos|oikos]] proposal a second cell kind exists beside this one: the **ledger-cell**, born by a name rather than by division, conserving one token's balance rather than minimizing a cut
