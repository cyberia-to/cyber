...
files are what flows through [[tape]] frames when an agent sends a thing rather than a raw atom. [[particles]] are the objects' identities; [[neurons]] are the subjects
