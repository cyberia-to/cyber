...
| 2026-09-23 | release train rules settled for cyb, cyber and soft3 (controls, cyberia/dev.md, root CLAUDE.md, the three repos' CLAUDE.md): weekly candidate from origin only, named gates, draft pre-release with receipts, one-PR bumps, phase-1 manifest, owner-only promotion. steps still to build: the manifest, the clean-checkout gate in CI, the candidate workflow, the bump script; first candidate 2026-09-25 |
