...
> **proposal on the table:** [[research/nomos|nomos]] — one token, one chain — would retire this page's *bridge* mode (token transport) entirely: import/export of proofs stay, tokens never move. undecided; see the adoption map in [[research/nomos|nomos]].
