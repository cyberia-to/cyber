...
version bump across all crates. not yet published. the [[semantic hashing]] specification moved from draft to accepted — every implementation detail pinned so two independent implementations produce identical hashes from identical input.
